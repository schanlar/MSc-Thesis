...
class MESA_STAR(object):
    ...
    def plotRhoT(self,
        ...
        labels = [r'$Z = 0.0001;f_{\rm OV} = 0.0$', r'$Z = 0.0001;f_{\rm OV} = 0.014$', r'$Z = 0.0001;f_{\rm OV} = 0.016$', 
            r'$Z = 0.001;f_{\rm OV} = 0.0$', r'$Z = 0.001;f_{\rm OV} = 0.014$', r'$Z = 0.001;f_{\rm OV} = 0.016$', r'$Z = 0.02;f_{\rm OV} = 0.0$', 
            r'$Z = 0.02;f_{\rm OV} = 0.014$', r'$Z = 0.02;f_{\rm OV} = 0.016$']
