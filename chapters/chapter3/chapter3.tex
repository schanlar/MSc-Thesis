...
\begin{document}
	...
	\chapter{Type-Ia Supernovae from non-accreting progenitors}\label{ch:paperI}
	
	\begin{center}
	John Antoniadis, \textbf{Savvas Chanlaridis}, G\"otz Gr\"afener, and Norbert Langer (2019, in prep)
	\newline
	\end{center}
...
Fig.\,\ref{fig:1} shows Kippenhahn diagrams for 
 \textsc{m1} and \textsc{m2}, focusing on the evolution after central helium depletion.
\begin{figure*}[htb!]
  \centering $
  \begin{array}{cc}
  \includegraphics[width=0.5\textwidth]{../figures/chapter3/kip_2p4.pdf} &
  \includegraphics[width=0.5\textwidth]{../figures/chapter3/kip_1p8.pdf} \\
  \end{array}$
  \caption{Kippenhahn diagrams following the evolution of $\rm \textsc{m1}=2.5\, M_{\odot}$ (left) and $\rm \textsc{m2}=1.8\, M_{\odot}$ He-stars, after core helium depletion. The x-axis represents star's age, whilst the y-axis shows the inner structure of the star in terms of mass coordinate. Colored areas indicate regions in which nuclear burning occurs, i.e. locations for which the nuclear energy $\epsilon_{\rm nuc}$ exceeds energy losses due to neutrion emission, $\epsilon_\nu$.}
  \label{fig:1}
\end{figure*}
...
Fig.\,\ref{fig:2} gives an overview of the central density and temperature evolution for models  \textsc{m1} and \textsc{m2}. %\deleted{(in blue and orange respectively)}.
